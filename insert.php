...
<form name="form2" method="post" style="margin:auto;">
             ...
             <tr><td>Category:</td><td width="349"><input type="text" name="category" />
               ...
               <tr><td>Platform:</td><td width="349"><input type="text" name="plateform"/></td>
                 ...
                 <tr><td>Warranty:</td><td width="349"><input type="text" name="waranty"/></td>
...
$query="insert into product values('','$pcode','$pname','$pcat','$price','$desc','$brand','$category','$features','$plateform','$model','$type','$display','$waranty','$shipping_time','$price','$offer_price','$save','$quantity','$image')";
