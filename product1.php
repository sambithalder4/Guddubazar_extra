...
<div style="margin: auto; height:auto; width: 1000px;">
 ...
 <!--************************Header********************************-->
    ...
    <!--************************Header close********************************-->
	  ...
	  <div style="width:1000px; height:800px; border:#ff0000 0px solid;background-color:#FFFFFF;">  

      <div style="width:200px; height:700px;border:#ff0000 0px solid; background-color:#FFFFFF; color:#ffffff; float:left; ">
